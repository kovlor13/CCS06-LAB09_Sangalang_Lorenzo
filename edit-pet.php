...
<form action="save-changes.php" method="POST">
	...
	<div>
		...
		<input type="text" name="owner" placeholder="Name of the owner" value="<?php echo $pet->getOwnerName();?>" />	
	</div>
	<div>
	...
	<div>
		...
		<input type="text" name="contact_number" placeholder="contact" value="<?php echo $pet->getContactNumber();?>" />	
	</div>
	<div>
		<button>
			Save
